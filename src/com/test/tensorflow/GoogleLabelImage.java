...
public class GoogleLabelImage {
    ...
    // String modelDir = "D:/QQDownload/inception5h";
    // String imageFile = "D:/tf_mode/2016022923025165608.jpg";
    //
    ...
    public static Tensor constructAndExecuteGraphToNormalizeImage(byte[] imageBytes) {
        try (Graph g = new Graph()) {
            ...
            final Output output = b.div(
                b.sub(
                    b.resizeBilinear(
                        b.expandDims(b.cast(b.decodeJpeg(input, 3), DataType.FLOAT), b.constant("make_batch", 0)),
...
//    }
     ...
     * @since jdk1.7
     * @version 2017年4月20日 yangzhenggang
     */
